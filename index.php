    ...
    <section class="ftco-section services-section bg-light">
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-3 d-flex align-self-stretch ftco">
			...
			<div class="container" data-aos="fade-up">
					...
					<div class="row justify-content-center">
						<div class="container">
							...
							<h2 class="mb-4"><strong>Our</strong> Services</h2>
					  </div>
					</div>    		
					</div>
					</div>
			  ...
			  <div class="row" >
				...
				<div  class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
				  <div class="box">
					<img src="assets/img/holiday.webp" class="img-fluid" alt=""><br>
					<h3>Holiday Package</h3>
					<p>We organize curated trips to your dream destinations </p>
			   
				  </div>
				</div>
				<div class="col-lg-4  mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
				  <div class="box">
					<img src="assets/img/bus.webp" class="img-fluid" alt="">
					<br>
					<h3>Bus Services</h3>
					<p>We have wide range of tourist buses available.</p>
			   
				  </div>
				</div>
				<div id="box" class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
				  <div class="box">
					<img src="assets/img/payment.webp" class="img-fluid" alt="">
					<br>
					<h3>Convenient Payment Method</h3>
					<p>All modes of payment accepted</p>
				  </div>
				</div>
				<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
				  <div class="box">
					<img src="assets/img/ticket.webp" class="img-fluid" alt=""><br>
					<h3>Airline Tickets</h3>
					<p>We provide you the best fare available in the market for airline tickets.</p>
				  </div>
				</div>
				<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
				  <div class="box">
					<img src="assets/img/document.webp" class="img-fluid" alt=""><br>
					<h3>Document Attestation</h3>
					<p>We provide Travel document attestation service consultation.</p>
				  </div>
				</div>
				<div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
				  <div class="box">
					<img src="assets/img/visa.webp" class="img-fluid" alt=""><br>
					<h3>Visa Services</h3>
					<p>Our Global Visa Services Department Team will assist you for your travel Visa process.</p>
				  </div>
				</div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-4 col-md-6">
                          <div class="single_destination">
                              ...
                              <div class="content">
                                  <p class="d-flex align-items-center"><?php echo htmlentities($result->DestinationName);?> <a href="travel_destination.html">  <?php echo htmlentities($result->DestinationPlaces);?></a> </p>
		...
		<div class="row" >
                <div class="col-lg-12">
                    <div class="more_place_btn text-center"  >
                        <a id="more" class="boxed-btn4"  href="#">More Places</a>
                    </div>
                </div>
            </div>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_1.jpg);">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ">
            <h2  class="mb-4">What we have achieved so far</h2>
      ...
      <div class="container">
        <div class="row justify-content-start">
          <div class="col-md-5 heading-section ">
          	<span class="subheading">Best Travel Agency</span>
            <h2 class="mb-4 pb-3"><strong>Why</strong> Choose Us?</h2>
            <p>If you are looking for a reliable tour operator in Kerala “CityLight Travels” is the right choice for you.Here are some reasons why:</p>
            <p>Experience and Trustworthiness,Friendly and Qualified Stuff,Best Price, no Hidden Fees,The Variety of Tours and Programs...</p>
            <p><a href="./about.html#features" class="btn btn-primary btn-outline-primary mt-4 px-4 py-3">Read more</a></p>
          </div>
