      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9  text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span>Destination</span></p>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide" style="height:90vh;width: 50vh;">
                  <img  src="admin/destintionimages/<?php echo htmlentities($result->DestinationImage);?>" class="img-responsive" alt="">
                </div>
          ...
          <div class="col-lg-6"   >
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: <?php echo htmlentities($result->DestinationName);?>n</li>
                <li><strong>Places</strong>: <?php echo htmlentities($result->DestinationPlaces);?></li>
              </ul>
            
            
              <h2>Description</h2>
              <p>
                <?php echo htmlentities($result->DestinationDes);?> 
              </p>
