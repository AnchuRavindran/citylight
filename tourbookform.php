...
$sql="INSERT INTO  tbltourbooking(PackageId,Name,Mail,Phone,State,Country,Address,Pincode,Child,Adult,FromDate) VALUES(:pkgId,:fname,:email,:mobile,:state,:country,:address,:pincode,:child,:adult,:checkin)";
...
.succWrap{
  ...
  <body>
	...
	<div class="container">
		...
		<form name="enquiry" method="post" action="#?pkgId=<?php echo $pkgId?>">
...
<b>Address</b>  <textarea name="address" class="form-control" rows="4" cols="50" id="address"  placeholder="Your Address" required=""></textarea> 
    ...
    <p style="width: 350px;">
<b>Pincode</b>  <input type="text" name="pincode" class="form-control" id="pincode" maxlength="10" placeholder="Your Pincode" required="">
</p> 

    <p style="width: 350px;">
<b>Childs</b>  <input type="text" name="child" class="form-control" id="child" maxlength="10" placeholder="childs" required="">
	</p> 
    <p style="width: 350px;">
<b>Adults</b>  <input type="text" name="adult" class="form-control" id="adult" maxlength="10" placeholder="adults" required="">
	</p> 
