      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9  text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Bus Details</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide" style="height:90vh;width: 50vh;">
                  <img  src="admin/busimages/<?php echo htmlentities($result->BusImage);?>" class="img-responsive" alt="">
                </div>
          ...
          <div class="col-lg-6"   >
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: <?php echo htmlentities($result->BusName);?>n</li>
                <li><strong>Seat</strong>: <?php echo htmlentities($result->BusSeat);?></li>
              </ul>
            
            
              <h2>Description</h2>
              <p>
                <?php echo htmlentities($result->BusDetails);?> 
              </p>
              <div class="row" >
          <div class="col-lg-12">
              <div class="more_place_btn text-center"  >
                  <a id="more" class="boxed-btn4"  href="./busbook.php">Book</a>
              </div>
          </div>
      </div>
