...
$type=$_POST['type'];
$sql="INSERT INTO  tbltourbooking(Name,Mail,Phone,State,Country,Address,Pincode,Child,Adult,FromDate) VALUES(:fname,:email,:mobile,:state,:country,:address,:pincode,:child,:adult,:checkin)";
