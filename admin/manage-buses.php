...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Manage Buses</li>
            </ol>
...
{				?>		
						  <tr>
                            ...
                            <td><?php echo htmlentities($result->BusSeat);?></td>
