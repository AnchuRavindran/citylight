...
<html>
<head>
<title>CityLight Travels| Admin Destination Updation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Destination </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<?php 
$did=intval($_GET['did']);
$sql = "SELECT * from tbldestination where DestinationId=:did";
$query = $dbh -> prepare($sql);
$query -> bindParam(':did', $did, PDO::PARAM_STR);
$query->execute();
...
{	?>
							...
							<form class="form-horizontal" name="destination" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="destinationname" id="destinationname" placeholder="Destination name" value="<?php echo htmlentities($result->DestinationName);?>" required>
									</div>
								</div>
<div class="form-group">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="destinationdes" id="destinationdes" placeholder=" Destination description" value="<?php echo htmlentities($result->DestinationDes);?>" required>
									</div>
								</div>
