...
$sql="INSERT INTO tblgallery(GalleryName,GalleryImage) VALUES(:pname,:pimage)";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Create Gallery</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="gallery" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="galleryname" id="galleryname" placeholder="Gallery Name" required>
									</div>
								</div>
