...
$sql="update tblbuses set BusImage=:pimage where BusId=:imgid";
...
<html>
<head>
<title>Citylight Travels | Admin Bus Update</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Update Bus Image </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       <h3>Update Bus Image </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT BusImage from tblbuses where BusId=:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="busimages/<?php echo htmlentities($result->BusImage);?>" width="200">
</div>
</div>
