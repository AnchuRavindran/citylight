...
<section id="portfolio" class="portfolio">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200" style="word-wrap: break-word;">
      ...
      <?php $sql = "SELECT * from tblgallery order by rand() ";
      ...
      <div class="portfolio-wrap">
        <img id="portimg" src="admin/galleryimages/<?php echo htmlentities($result->GalleryImage);?>" alt="" class="img-fluid">
        <div class="portfolio-info">
          <h4><?php echo htmlentities($result->GalleryName);?></h4>
      
          <div class="portfolio-links">
          <a  href="admin/galleryimages/<?php echo htmlentities($result->GalleryImage);?>" data-gallery="portfolioGallery"  class="portfolio-lightbox preview-link" >+</a>
        </div>
        </div>
      </div>
      </div>
